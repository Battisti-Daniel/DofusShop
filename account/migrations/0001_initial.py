    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characteristics', models.ManyToManyField(to='account.typecharacteristic')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('value', models.IntegerField()),
                ('typeCharacteristic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.typecharacteristic')),
            ],
        ),
    ]
